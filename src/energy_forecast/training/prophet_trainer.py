...
from energy_forecast.training.results import SplitResult as ProphetSplitResult
...
class ProphetTrainer:
    ...
    def run(self, df: pd.DataFrame) -> ProphetPipelineResult:
        ...
        try:
            config_hash = compute_config_hash(self._settings, "prophet")
            save_oof_cache(
                "prophet", best_result.split_results, self._settings.paths.models_dir, config_hash
            )
